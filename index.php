...
<body>
  ...
  <footer class="container-fluid py-5">
    <div class="row">
      ...
      <div class="col-sm-4">
        <h5>Our setting:</h5>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, est praesentium. Dolore aliquam, ducimus fugit fugiat molestias aperiam mollitia repellendus consequuntur asperiores cum voluptatum, nihil a saepe quia sapiente vel.</p>
      </div>
      <div class="col-sm-4">
        <h5>Navigation:</h5>
        <ul class='list-group'>
